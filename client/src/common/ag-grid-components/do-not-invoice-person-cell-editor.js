...
function DoNotInvoicePeronCellEditor() {
}

DoNotInvoicePeronCellEditor.prototype.init = function (params) {
...
DoNotInvoicePeronCellEditor.prototype.getGui = function () {
	return this.eGui;
};

module.exports = DoNotInvoicePeronCellEditor;