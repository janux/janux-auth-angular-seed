...
module.exports = {
  ...
  server: {
    ...
    distFolder: path.resolve(__dirname, '../../client-orig/dist'), // The folder that contains the application files (note that the files are in a different repository) - relative to this file
