...
const VEHICLE_COLLECTION                 = "vehicle",
      ...
      OPERATION_RESOURCE_COLLECTION      = "operationResource",
...
if (dbEngine === DataSourceHandler.MONGOOSE) {
	...
	exportsDaos = {
		...
		operationResourceDao  : DaoFactory.subscribeDao(new DaoSettings(dbEngine, pathMongo, OPERATION_RESOURCE_COLLECTION, EntityPropertiesImpl.createDefaultProperties(), CurrentResourceMongooseSchema), CurrentResourceDao),
	...
	exportsDaos = {
		...
		operationResourceDao  : DaoFactory.subscribeDao(new DaoSettings(dbEngine, pathMongo, OPERATION_RESOURCE_COLLECTION, EntityPropertiesImpl.createDefaultProperties()), CurrentResourceDao),
