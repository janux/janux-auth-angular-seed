...
var config                         = require('config'),
	...
	AccountActionDao               = DAOs[appContext.dao.accountActionDao],
	...
	UserActionService			   = require('./user-action-service'),
	...
	UserActionPersistenceService = UserActionServiceProd.createInstance(AccountActionDao, UserPersistenceService, PartyPersistenceService, CommService);

module.exports = {
	UserService           : UserService.create(UserPersistenceService),
	UserActionService     : UserActionService.create(UserActionPersistenceService),
