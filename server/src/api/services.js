...
var UserPersistence                        = require('janux-persist').UserService,
    ...
    RateMatrixServiceImpl                  = require('glarus-services').RateMatrixService,
...
var config                              = require('config'),
    ...
    TimeRecordDao                       = DAOs[appContext.dao.timeRecordDao],
    ResourceDao                         = DAOs[appContext.dao.resourceDao],
    OperationResourceDao                = DAOs[appContext.dao.operationResourceDao],
    ...
    ResourcePersistService              = new ResourceServiceImpl(ResourceDao, PartyPersistenceService, VehicleDao, OperationResourceDao, TimeRecordResourceDao),
    ...
    InvoiceCalculatorServicePersistence = new InvoiceCalculatorService(
	    ...
	    TaskTypeService,
	    TaskRelationDao),
    TimeRecordPersistService            = new TimeRecordServiceImpl(OperationDao, TimeRecordDao, TimeRecordAttributeDao, TimeEntryPrincipalDao, TimeRecordResourceDao, ResourcePersistService, PartyPersistenceService, VehicleDao, TaskRelationDao, InvoiceCalculatorServicePersistence, OperationAttributeDao, InvoiceItemTEDao, InvoiceItemDao, InvoiceDao),
    OperationPersistService             = new OperationServiceImpl(OperationDao, TimeRecordPersistService, ResourcePersistService, PartyPersistenceService, VehicleDao, OperationResourceDao, OperationPrincipalDao, OperationAttributeDao, TaskRelationDao),
    ...
    TimeEntryReportService              = new TimeRecordReportServiceImpl(OperationPersistService, TimeRecordPersistService, RateMatrixService, GlarusUserPersistenceService, TaskRelationDao),
    TimeEntryReportGuardService         = new TimeRecordReportGuardServiceImpl(OperationPersistService, TimeRecordPersistService, RateMatrixService, GlarusUserPersistenceService, TaskRelationDao),
    TimeEntryReportSpecialOpsService    = new TimeRecordReportSpecialOpsServiceImpl(OperationPersistService, TimeRecordPersistService, RateMatrixService, GlarusUserPersistenceService, TaskRelationDao),
    TimeEntryReportAttendanceService    = new TimeRecordReportAttendanceServiceImpl(OperationPersistService, TimeRecordPersistService, TaskRelationDao),
    RateMatrixResellerService           = new RateMatrixResellerServiceImpl(RateMatrixService, ResellerPersistenceService),
    InvoiceService                      = new InvoiceServiceImpl(InvoiceDao, InvoiceItemDao, ExpenseDao, InvoiceOperationDao, InvoiceItemTEDao, PartyPersistenceService, TimeRecordDao, TimeRecordPersistService, RateMatrixService, OperationDao, InvoiceCalculatorServicePersistence, OperationPersistService, RateMatrixResellerService, TaskRelationDao),
    InvoiceTimeEntryService             = new InvoiceTimeEntryServiceImpl(InvoiceItemTEDao, InvoiceItemDao, InvoiceDao, TimeRecordDao, TaskRelationDao),
...
module.exports = {
	...
	TimeEntryPersistService           : TimeRecordPersistService,
